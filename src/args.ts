    ...
    path: Args.custom<string>(
      {
        ...
        options: [
          ...
          ["sea", "11,037 Leagues Under the Sea (Work in Progress)"],
        ],
        setting: "",
      },
    ...
    aftercore: Args.group("Path: Aftercore", {
      goal: Args.string({
        ...
        options: [
          ...
          ["violence", "Complete the sea as a gladiator"],
          ["hatred", "Complete the sea as a scholar"],
          ["loathing", "Complete the sea to fight Dad"],
        ],
        setting: "",
      }),
    }),
