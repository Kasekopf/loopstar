  ...
  tasks: [
    ...
    },
    {
      ...
      combat: new CombatStrategy()
        ...
        }, $monsters`Mer-kin healer`)
        .macro((): Macro => {
          return Macro.trySkill($skill`Darts: Throw at %part1`).tryItem($item`anchor bomb`);
        }, $monsters`Mer-kin burglar, Mer-kin raider`),
      outfit: {
      ...
      combat: new CombatStrategy()
        .macro((): Macro => {
          return Macro.trySkill($skill`Darts: Throw at %part1`)
            .if_("hastwocombatitems 11685", Macro.tryItem($item`handful of split pea soup`))
    ...
    },
    {
      ...
      combat: new CombatStrategy()
        .macro((): Macro => {
          return Macro.while_("!monstername Mer-kin rustler", Macro.tryItem($item`waffle`))
    ...
    },
    {
      ...
      combat: new CombatStrategy()
        ...
        .killHard($monsters`Peanut`)
        .macro((): Macro => {
          return Macro.item($item`spooky VHS tape`, $item`sea lasso`).skill(
    ...
    },
    {
      ...
      combat: new CombatStrategy()
        .macro((): Macro => {
          return Macro.item($item`spooky VHS tape`).trySkill($skill`Assert your Authority`);
        }, $monsters`eye in the darkness, school of many, slithering thing`)
        .killHard($monsters`Peanut`),
      outfit: {
        familiar: $familiar`Peace Turkey`,
