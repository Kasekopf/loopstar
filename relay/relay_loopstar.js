...
var getFamiliar = createMafiaClassPropertyGetter(import_kolmafia3.Familiar, import_kolmafia3.toFamiliar, familiarNumericProperties);
var getItem = createMafiaClassPropertyGetter(import_kolmafia3.Item, import_kolmafia3.toItem, itemNumericProperties);
var getLocation = createMafiaClassPropertyGetter(import_kolmafia3.Location, import_kolmafia3.toLocation);
var getMonster = createMafiaClassPropertyGetter(import_kolmafia3.Monster, import_kolmafia3.toMonster, monsterNumericProperties);
...
function _wrapNativeSuper2(t) {
  var r = "function" == typeof Map ? /* @__PURE__ */ new Map() : void 0;
  return _wrapNativeSuper2 = function _wrapNativeSuper3(t2) {
...
function saveCached(cacheKey, options) {
  ...
  if ((0, import_kolmafia7.equippedAmount)($item(_templateObject332 || (_templateObject332 = _taggedTemplateLiteral2(["card sleeve"])))) > 0) {
    equipment.set($slot(_templateObject342 || (_templateObject342 = _taggedTemplateLiteral2(["card-sleeve"]))), (0, import_kolmafia7.equippedItem)($slot(_templateObject35 || (_templateObject35 = _taggedTemplateLiteral2(["card-sleeve"])))));
  }
  if ((0, import_kolmafia7.equippedAmount)($item(_templateObject36 || (_templateObject36 = _taggedTemplateLiteral2(["Crown of Thrones"])))) > 0) {
    rider.set($item(_templateObject37 || (_templateObject37 = _taggedTemplateLiteral2(["Crown of Thrones"]))), (0, import_kolmafia7.myEnthronedFamiliar)());
  }
  if ((0, import_kolmafia7.equippedAmount)($item(_templateObject38 || (_templateObject38 = _taggedTemplateLiteral2(["Buddy Bjorn"])))) > 0) {
    rider.set($item(_templateObject39 || (_templateObject39 = _taggedTemplateLiteral2(["Buddy Bjorn"]))), (0, import_kolmafia7.myBjornedFamiliar)());
  }
  if (options.preventSlot && options.preventSlot.length > 0) {
    ...
    if (options.preventSlot.includes($slot(_templateObject40 || (_templateObject40 = _taggedTemplateLiteral2(["buddy-bjorn"]))))) {
      rider.delete($item(_templateObject41 || (_templateObject41 = _taggedTemplateLiteral2(["Buddy Bjorn"]))));
    }
    if (options.preventSlot.includes($slot(_templateObject42 || (_templateObject42 = _taggedTemplateLiteral2(["crown-of-thrones"]))))) {
      rider.delete($item(_templateObject43 || (_templateObject43 = _taggedTemplateLiteral2(["Crown of Thrones"]))));
    }
  }
  if (options.onlySlot && options.onlySlot.length > 0) {
    ...
    if (!options.onlySlot.includes($slot(_templateObject44 || (_templateObject44 = _taggedTemplateLiteral2(["buddy-bjorn"]))))) {
      rider.delete($item(_templateObject45 || (_templateObject45 = _taggedTemplateLiteral2(["Buddy Bjorn"]))));
    }
    if (!options.onlySlot.includes($slot(_templateObject46 || (_templateObject46 = _taggedTemplateLiteral2(["crown-of-thrones"]))))) {
...
function maximizeCached(objectives) {
  ...
  var objective = _toConsumableArray5(new Set([].concat(_toConsumableArray5(objectives.sort()), _toConsumableArray5(forceEquip.map(function(item) {
    ...
    var _ref1 = _slicedToArray4(_ref0, 2), item = _ref1[0], bonus = _ref1[1];
...
function _possibleConstructorReturn3(t, e) {
  if (e && ("object" == _typeof7(e) || "function" == typeof e)) return e;
  if (void 0 !== e) throw new TypeError("Derived constructors may only return object or undefined");
...
var CombatStrategy = /* @__PURE__ */ function() {
  ...
  return _createClass7(CombatStrategy2, [{
    ...
    value: function withActions(actions) {
      ...
      var _iterator0 = _createForOfIteratorHelper7(actions), _step0;
      try {
...
var Outfit = /* @__PURE__ */ function() {
  ...
  return _createClass8(Outfit2, [{
    ...
    value: function equipNonAccessory(item, slot) {
      if ($slots(_templateObject53 || (_templateObject53 = _taggedTemplateLiteral3(["acc1, acc2, acc3"]))).includes((0, import_kolmafia9.toSlot)(item))) return false;
      ...
      switch ((0, import_kolmafia9.toSlot)(item)) {
        case $slot(_templateObject211 || (_templateObject211 = _taggedTemplateLiteral3(["off-hand"]))):
          ...
          break;
        case $slot(_templateObject54 || (_templateObject54 = _taggedTemplateLiteral3(["familiar"]))):
        ...
        case $slot(_templateObject62 || (_templateObject62 = _taggedTemplateLiteral3(["weapon"]))):
          if (!weaponsCompatible(item, this.equips.get($slot(_templateObject72 || (_templateObject72 = _taggedTemplateLiteral3(["off-hand"])))))) return false;
          break;
      }
      if ((0, import_kolmafia9.toSlot)(item) !== $slot(_templateObject82 || (_templateObject82 = _taggedTemplateLiteral3(["familiar"]))) && !(0, import_kolmafia9.canEquip)(item)) return false;
    ...
    value: function equipAccessory(item, slot) {
      var _this = this;
      if (![void 0].concat(_toConsumableArray7($slots(_templateObject92 || (_templateObject92 = _taggedTemplateLiteral3(["acc1, acc2, acc3"]))))).includes(slot)) return false;
      if ((0, import_kolmafia9.toSlot)(item) !== $slot(_templateObject02 || (_templateObject02 = _taggedTemplateLiteral3(["acc1"])))) return false;
      if (!(0, import_kolmafia9.canEquip)(item)) return false;
      if (slot === void 0) {
        var empty = $slots(_templateObject111 || (_templateObject111 = _taggedTemplateLiteral3(["acc1, acc2, acc3"]))).find(function(s) {
    ...
    value: function equipUsingDualWield(item, slot) {
      if (![void 0, $slot(_templateObject103 || (_templateObject103 = _taggedTemplateLiteral3(["off-hand"])))].includes(slot)) return false;
      ...
      if (!(0, import_kolmafia9.canEquip)(item)) return false;
      if (!weaponsCompatible(this.equips.get($slot(_templateObject163 || (_templateObject163 = _taggedTemplateLiteral3(["weapon"])))), item)) return false;
      this.equips.set($slot(_templateObject173 || (_templateObject173 = _taggedTemplateLiteral3(["off-hand"]))), item);
      return true;
    }
  }, {
    ...
    value: function equipUsingFamiliar(item, slot) {
      if (![void 0, $slot(_templateObject263 || (_templateObject263 = _taggedTemplateLiteral3(["familiar"])))].includes(slot)) return false;
      if (this.equips.has($slot(_templateObject273 || (_templateObject273 = _taggedTemplateLiteral3(["familiar"]))))) return false;
      if ((0, import_kolmafia9.booleanModifier)(item, "Single Equip")) return false;
      var familiar = this.getHoldingFamiliar(item);
      if (familiar === void 0 || $familiars(_templateObject283 || (_templateObject283 = _taggedTemplateLiteral3(["Fancypants Scarecrow, Mad Hatrack"]))).includes(familiar) && slot === void 0) {
        return false;
      }
      if (!this.equip(familiar)) return false;
      this.equips.set($slot(_templateObject293 || (_templateObject293 = _taggedTemplateLiteral3(["familiar"]))), item);
      return true;
    }
  }, {
    key: "equipItem",
    ...
    value: function equipSpec(spec) {
      ...
      for (var _i = 0, _outfitSlots2 = outfitSlots; _i < _outfitSlots2.length; _i++) {
        ...
        var slot = (_a = (/* @__PURE__ */ new Map([["famequip", $slot(_templateObject313 || (_templateObject313 = _taggedTemplateLiteral3(["familiar"])))], ["offhand", $slot(_templateObject323 || (_templateObject323 = _taggedTemplateLiteral3(["off-hand"])))]])).get(slotName)) !== null && _a !== void 0 ? _a : (0, import_kolmafia9.toSlot)(slotName);
    ...
    value: function _dress(refreshed) {
      ...
      var nonaccessorySlots = $slots(_templateObject352 || (_templateObject352 = _taggedTemplateLiteral3(["weapon, off-hand, hat, back, shirt, pants, familiar"])));
      var bjorn = this.riders.get($slot(_templateObject362 || (_templateObject362 = _taggedTemplateLiteral3(["buddy-bjorn"]))));
      if (bjorn && (this.equips.get($slot(_templateObject372 || (_templateObject372 = _taggedTemplateLiteral3(["back"])))) === $item(_templateObject382 || (_templateObject382 = _taggedTemplateLiteral3(["Buddy Bjorn"]))) || this.getBonus($item(_templateObject392 || (_templateObject392 = _taggedTemplateLiteral3(["Buddy Bjorn"])))))) {
      ...
      if (crown && (this.equips.get($slot(_templateObject432 || (_templateObject432 = _taggedTemplateLiteral3(["hat"])))) === $item(_templateObject442 || (_templateObject442 = _taggedTemplateLiteral3(["Crown of Thrones"]))) || this.getBonus($item(_templateObject452 || (_templateObject452 = _taggedTemplateLiteral3(["Crown of Thrones"])))))) {
        usedSlots.add($slot(_templateObject462 || (_templateObject462 = _taggedTemplateLiteral3(["buddy-bjorn"]))));
        usedSlots.add($slot(_templateObject473 || (_templateObject473 = _taggedTemplateLiteral3(["crown-of-thrones"]))));
      }
      if (weaponHands((0, import_kolmafia9.equippedItem)($slot(_templateObject483 || (_templateObject483 = _taggedTemplateLiteral3(["weapon"]))))) !== 1 && this.equips.has($slot(_templateObject492 || (_templateObject492 = _taggedTemplateLiteral3(["offhand"])))) && !this.equips.has($slot(_templateObject502 || (_templateObject502 = _taggedTemplateLiteral3(["weapon"]))))) (0, import_kolmafia9.equip)($slot(_templateObject512 || (_templateObject512 = _taggedTemplateLiteral3(["weapon"]))), $item.none);
      if (!weaponsCompatible(this.equips.get($slot(_templateObject522 || (_templateObject522 = _taggedTemplateLiteral3(["weapon"])))), (0, import_kolmafia9.equippedItem)($slot(_templateObject532 || (_templateObject532 = _taggedTemplateLiteral3(["off-hand"])))))) (0, import_kolmafia9.equip)($slot(_templateObject542 || (_templateObject542 = _taggedTemplateLiteral3(["off-hand"]))), $item.none);
      var _iterator3 = _createForOfIteratorHelper8(nonaccessorySlots), _step3;
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
          var slot = _step3.value;
          if (targetEquipment.includes((0, import_kolmafia9.equippedItem)(slot)) && this.equips.get(slot) !== (0, import_kolmafia9.equippedItem)(slot) || this.avoid.includes((0, import_kolmafia9.equippedItem)(slot))) (0, import_kolmafia9.equip)(slot, $item.none);
        }
      } catch (err) {
        _iterator3.e(err);
      } finally {
      ...
      var accessorySlots = $slots(_templateObject55 || (_templateObject55 = _taggedTemplateLiteral3(["acc1, acc2, acc3"])));
      ...
      applyModes(modes);
      if (bjorn && (0, import_kolmafia9.haveEquipped)($item(_templateObject56 || (_templateObject56 = _taggedTemplateLiteral3(["Buddy Bjorn"]))))) {
      ...
      if (crown && (0, import_kolmafia9.haveEquipped)($item(_templateObject57 || (_templateObject57 = _taggedTemplateLiteral3(["Crown of Thrones"]))))) {
    ...
    value: function spec() {
      ...
      for (var _i5 = 0, _outfitSlots2 = outfitSlots; _i5 < _outfitSlots2.length; _i5++) {
        ...
        var entry = this.equips.get((_a = (/* @__PURE__ */ new Map([["famequip", $slot(_templateObject622 || (_templateObject622 = _taggedTemplateLiteral3(["familiar"])))], ["offhand", $slot(_templateObject63 || (_templateObject63 = _taggedTemplateLiteral3(["off-hand"])))]])).get(slotName)) !== null && _a !== void 0 ? _a : (0, import_kolmafia9.toSlot)(slotName));
        if (entry) result[slotName] = entry;
      }
      var riders = {};
      var buddyRider = this.riders.get($slot(_templateObject64 || (_templateObject64 = _taggedTemplateLiteral3(["buddy-bjorn"]))));
    ...
    value: function current() {
      ...
      for (var _i6 = 0, _outfitSlots3 = outfitSlots; _i6 < _outfitSlots3.length; _i6++) {
        ...
        var slot = (_a = (/* @__PURE__ */ new Map([["famequip", $slot(_templateObject66 || (_templateObject66 = _taggedTemplateLiteral3(["familiar"])))], ["offhand", $slot(_templateObject67 || (_templateObject67 = _taggedTemplateLiteral3(["off-hand"])))]])).get(slotName)) !== null && _a !== void 0 ? _a : (0, import_kolmafia9.toSlot)(slotName);
      ...
      if ((0, import_kolmafia9.haveEquipped)($item(_templateObject68 || (_templateObject68 = _taggedTemplateLiteral3(["Crown of Thrones"]))))) outfit2.riders.set($slot(_templateObject69 || (_templateObject69 = _taggedTemplateLiteral3(["crown-of-thrones"]))), (0, import_kolmafia9.myEnthronedFamiliar)());
      if ((0, import_kolmafia9.haveEquipped)($item(_templateObject70 || (_templateObject70 = _taggedTemplateLiteral3(["Buddy Bjorn"]))))) outfit2.riders.set($slot(_templateObject71 || (_templateObject71 = _taggedTemplateLiteral3(["buddy-bjorn"]))), (0, import_kolmafia9.myBjornedFamiliar)());
...
function weaponsCompatible(weapon, offhand) {
  if (!weapon || weapon === $item(_templateObject722 || (_templateObject722 = _taggedTemplateLiteral3(["none"])))) return true;
  if (!offhand || offhand === $item(_templateObject73 || (_templateObject73 = _taggedTemplateLiteral3(["none"])))) return true;
  if ((0, import_kolmafia9.toSlot)(offhand) !== $slot(_templateObject74 || (_templateObject74 = _taggedTemplateLiteral3(["weapon"])))) return true;
  var weaponStat = (0, import_kolmafia9.weaponType)(weapon);
  var offhandStat = (0, import_kolmafia9.weaponType)(offhand);
  if (weaponStat === $stat(_templateObject75 || (_templateObject75 = _taggedTemplateLiteral3(["Moxie"]))) && (offhandStat === $stat(_templateObject76 || (_templateObject76 = _taggedTemplateLiteral3(["Mysticality"]))) || offhandStat === $stat(_templateObject77 || (_templateObject77 = _taggedTemplateLiteral3(["Muscle"]))))) return false;
  if (offhandStat === $stat(_templateObject78 || (_templateObject78 = _taggedTemplateLiteral3(["Moxie"]))) && (weaponStat === $stat(_templateObject79 || (_templateObject79 = _taggedTemplateLiteral3(["Mysticality"]))) || weaponStat === $stat(_templateObject80 || (_templateObject80 = _taggedTemplateLiteral3(["Muscle"]))))) return false;
  return true;
}
...
var ContextualEngine = /* @__PURE__ */ function() {
  function ContextualEngine2(tasks, options) {
    var _this = this;
    _classCallCheck9(this, ContextualEngine2);
    this.attempts = {};
  ...
  return _createClass9(ContextualEngine2, [{
    ...
    value: function setCombat(task, task_combat, task_resources) {
      var _a;
      var macro = task_combat.compile(task_resources, (_a = this.options) === null || _a === void 0 ? void 0 : _a.combat_defaults, task.do instanceof import_kolmafia10.Location ? task.do : void 0, this.getContext(task));
      macro.save();
      if (!this.options.ccs) {
...
var zoneSpecificNCs = new Map(Object.entries((0, import_kolmafia10.fileToBuffer)("data/encounters.txt").split("\n").reduce(function(obj, line) {
  var _a;
  var _line$split = line.split("	"), _line$split2 = _slicedToArray6(_line$split, 3), location = _line$split2[0], type = _line$split2[1], name = _line$split2[2];
  if (type !== "TURTLE" || location === "*") return obj;
  return _objectSpread5(_objectSpread5({}, obj), {}, _defineProperty7({}, name, [].concat(_toConsumableArray8((_a = obj[name]) !== null && _a !== void 0 ? _a : []), [(0, import_kolmafia10.toLocation)(location)])));
}, {})));
...
var args = Args.create("loopstar", 'This is a script to complete runs in a single day for supported paths.\n\nRun "loopstar sim" without quotes to check if this script will work for you in a casual run. You can also set the path option (for example "loopstar sim path=smol") to check with different supported paths.\n\nThe arguments accepted by the script are listed below. Note that you can combine multiple options; for example "loopstar pulls=18 fax=false" will save 2 pulls and avoid using a faxbot. Most options also have an associated setting to set an option permanently; for example "set loopstar_pulls=18" will cause the script to always save 2 pulls (unless overriden by using the pulls option at runtime).', {
  ...
  major: Args.group("Major Options", {
    ...
    workshed: Args.custom({
      ...
      default: $item(_templateObject610 || (_templateObject610 = _taggedTemplateLiteral5(["model train set"])))
    }, workshedParser, "ITEM"),
    swapworkshed: Args.custom({
      help: "Workshed item to place in a workshed to replace the cold medicine cabinet.",
      default: $item(_templateObject710 || (_templateObject710 = _taggedTemplateLiteral5(["none"])))
    }, workshedParser, "ITEM")
  }),
  minor: Args.group("Minor Options", {
    ...
    stillsuit: Args.familiar({
      ...
      default: $familiar(_templateObject84 || (_templateObject84 = _taggedTemplateLiteral5(["Gelatinous Cubeling"])))
    }),
    delevel: Args.flag({
  ...
  metadata.traverse(function(key, name) {
    ...
    if (key.valueHelpName === "FLAG" || key.valueHelpName === "BOOLEAN") {
      ...
      component2.dropdown = supportedWorksheds.map(function(i2) {
        var name2 = i2 === $item(_templateObject85 || (_templateObject85 = _taggedTemplateLiteral6(["none"]))) ? "none" : i2.name;
        return {
          display: name2,
          value: name2
        };
...
function main() {
  ...
  (0, import_kolmafia12.write)((0, import_mafia_shared_relay.generateHTML)(convertArgsToHtml()));
}
